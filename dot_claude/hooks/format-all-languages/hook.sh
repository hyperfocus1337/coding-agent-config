...
# markdown/MDX paragraphs and YAML block scalars (no effect on
# json/js/ts/css). Errors (no prettier, parse failure) are swallowed; a
# formatter never fails an edit.
