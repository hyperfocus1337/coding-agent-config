...
Do this check before you give the text to the user. If a line fails, correct the text and do the check again.
...
- [ ] Each article ("a", "an", "the") is in its correct position.
- [ ] Each abbreviation has its full term at the first use.
- [ ] There is no slash, but "and/or" is permitted.
...
- [ ] Each warning is before the step that it applies to.
- [ ] Each caution is before the step that it applies to.
- [ ] Each warning gives the risk of injury or death.
- [ ] Each caution gives the risk of damage.
- [ ] No safety data was removed.

## Accuracy

- [ ] Each technical name is the same as in the source text.
- [ ] Each number, tolerance, and unit is the same as in the source text.
