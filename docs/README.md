...
└── research/                 # Investigations into the agent environment and session
    ...
    ├── prompt-cache-ttl.md   — What the 1-hour prompt cache TTL costs, and when it loses
